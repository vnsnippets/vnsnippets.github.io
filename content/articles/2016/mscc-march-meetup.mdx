...
Title: 2016/03 MSCC Meetup - .NET Core
...
Last Saturday, I attended a meetup on the theme of open source software. The meetup itself was interesting and informative, with attendees mostly from the Mauritius Software Craftsmanship MSCC Meetup (MSCC) and Microsoft Student Partners (MSP).
